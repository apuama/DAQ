...
class MLX90614():
    ...
    def data_to_temp(self, data):
        temp = (data*0.02) - 272.15 #off set de -1 grau
        return temp
...
f = open ("/home/pi/Desktop/Disco67.txt",  'a')#abre o arquivo na forma de leitura e na forma "append" (significa que sempre salva no fim do arquivo referente sem sobreescreve-lo)
f.write (str(hoje))
f.write('\nInfravermelho 67')
...
while(1):
    try:
        if __name__ == "__main__":
            ...
            f = open ("/home/pi/Desktop/Disco67.txt",  'a')
            f.write('\n')
